@extends('layouts.app')
@section('title', 'Tambah Job Schedule')
...
<div class="p-6 max-w-3xl mx-auto">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900">Tambah Job Schedule</h1>
            <p class="text-sm text-gray-400">Tambahkan job pengiriman data baru</p>
        </div>
    </div>

    <form method="POST" action="{{ route('job-schedule.store') }}">
        @csrf
